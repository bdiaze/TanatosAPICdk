...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    ALTER TABLE tanatos.norma_suscrita ALTER COLUMN procesos_notificaciones SET NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE TABLE tanatos.tipo_proceso_automatico (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        nombre text NOT NULL,
        descripcion text,
        habilitado boolean NOT NULL,
        ...
        fecha_eliminacion timestamp with time zone,
        vigencia boolean NOT NULL,
        CONSTRAINT "PK_tipo_proceso_automatico" PRIMARY KEY (id)
    );
    COMMENT ON TABLE tanatos.tipo_proceso_automatico IS 'Tabla que contiene los tipos de procesos automáticos.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.id IS 'Identificador del tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.nombre IS 'Nombre del tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.descripcion IS 'Descripción del tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.habilitado IS 'Indicador de si el tipo de proceso automático está habilitado.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.orden IS 'Orden en que se presenta el tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.fecha_creacion IS 'Fecha en que se creó el tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.fecha_eliminacion IS 'Fecha en que se eliminó el tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.tipo_proceso_automatico.vigencia IS 'Vigencia del tipo de proceso automático.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE TABLE tanatos.proceso_automatico (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        id_tipo_proceso_automatico bigint NOT NULL,
        id_proceso_kairos text NOT NULL,
        id_calendarizacion_kairos text NOT NULL,
        nombre text NOT NULL,
        arn_rol text NOT NULL,
        arn_proceso text NOT NULL,
        parametros text NOT NULL,
        cron text,
        frecuencia_dias integer,
        inicio_ejecucion_utc timestamp with time zone,
        fecha_creacion timestamp with time zone NOT NULL,
        fecha_eliminacion timestamp with time zone,
        vigencia boolean NOT NULL,
        CONSTRAINT "PK_proceso_automatico" PRIMARY KEY (id),
        CONSTRAINT "FK_proceso_automatico_tipo_proceso_automatico_id_tipo_proceso_~" FOREIGN KEY (id_tipo_proceso_automatico) REFERENCES tanatos.tipo_proceso_automatico (id) ON DELETE RESTRICT
    );
    COMMENT ON TABLE tanatos.proceso_automatico IS 'Tabla que contiene los procesos automáticos.';
    COMMENT ON COLUMN tanatos.proceso_automatico.id IS 'Identificador del proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.id_tipo_proceso_automatico IS 'Identificador del tipo de proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.id_proceso_kairos IS 'Identificador del proceso en Kairos.';
    COMMENT ON COLUMN tanatos.proceso_automatico.id_calendarizacion_kairos IS 'Identificador de la calendarización en Kairos.';
    COMMENT ON COLUMN tanatos.proceso_automatico.nombre IS 'Nombre del proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.arn_rol IS 'ARN del rol con permisos de ejecución del proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.arn_proceso IS 'ARN del proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.parametros IS 'Parámetros requeridos por el proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.cron IS 'Cron de ejecución del proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.frecuencia_dias IS 'Frecuencia en días en que se ejecuta el proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.inicio_ejecucion_utc IS 'Fecha en que inicia las ejecuciones del proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.fecha_creacion IS 'Fecha en que se creó el proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.fecha_eliminacion IS 'Fecha en que se eliminó el proceso automático.';
    COMMENT ON COLUMN tanatos.proceso_automatico.vigencia IS 'Vigencia del proceso automático.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE TABLE tanatos.norma_suscrita_proceso_notificacion (
        id bigint GENERATED BY DEFAULT AS IDENTITY,
        id_norma_suscrita bigint NOT NULL,
        id_proceso_automatico bigint NOT NULL,
        fecha_creacion timestamp with time zone NOT NULL,
        fecha_eliminacion timestamp with time zone,
        vigencia boolean NOT NULL,
        CONSTRAINT "PK_norma_suscrita_proceso_notificacion" PRIMARY KEY (id),
        CONSTRAINT "FK_norma_suscrita_proceso_notificacion_norma_suscrita_id_norma~" FOREIGN KEY (id_norma_suscrita) REFERENCES tanatos.norma_suscrita (id) ON DELETE RESTRICT,
        CONSTRAINT "FK_norma_suscrita_proceso_notificacion_proceso_automatico_id_p~" FOREIGN KEY (id_proceso_automatico) REFERENCES tanatos.proceso_automatico (id) ON DELETE RESTRICT
    );
    COMMENT ON TABLE tanatos.norma_suscrita_proceso_notificacion IS 'Tabla que contiene las relaciones entre normas suscritas y procesos de notificación.';
    COMMENT ON COLUMN tanatos.norma_suscrita_proceso_notificacion.id IS 'Identificador de la relación.';
    COMMENT ON COLUMN tanatos.norma_suscrita_proceso_notificacion.id_norma_suscrita IS 'Identificador de la norma suscrita.';
    COMMENT ON COLUMN tanatos.norma_suscrita_proceso_notificacion.id_proceso_automatico IS 'Identificador del proceso de notificación.';
    COMMENT ON COLUMN tanatos.norma_suscrita_proceso_notificacion.fecha_creacion IS 'Fecha en que se creó la relación.';
    COMMENT ON COLUMN tanatos.norma_suscrita_proceso_notificacion.fecha_eliminacion IS 'Fecha en que se eliminó la relación.';
    COMMENT ON COLUMN tanatos.norma_suscrita_proceso_notificacion.vigencia IS 'Vigencia de la relación.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE INDEX "IX_norma_suscrita_proceso_notificacion_id_norma_suscrita" ON tanatos.norma_suscrita_proceso_notificacion (id_norma_suscrita);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE INDEX "IX_norma_suscrita_proceso_notificacion_id_proceso_automatico" ON tanatos.norma_suscrita_proceso_notificacion (id_proceso_automatico);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE INDEX "IX_proceso_automatico_id_tipo_proceso_automatico" ON tanatos.proceso_automatico (id_tipo_proceso_automatico);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    CREATE INDEX "IX_proceso_automatico_nombre" ON tanatos.proceso_automatico (nombre);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260824211944_ModeloProcesosAutomaticos') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260824211944_ModeloProcesosAutomaticos', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260902172417_DropColumnProcesosNotificacionNormaSuscrita') THEN
    ALTER TABLE tanatos.norma_suscrita DROP COLUMN procesos_notificaciones;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260902172417_DropColumnProcesosNotificacionNormaSuscrita') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260902172417_DropColumnProcesosNotificacionNormaSuscrita', '10.0.9');
    END IF;
END $EF$;
COMMIT;
