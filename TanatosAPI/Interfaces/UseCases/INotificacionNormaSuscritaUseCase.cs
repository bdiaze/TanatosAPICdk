...
namespace TanatosAPI.Interfaces.UseCases {
	public interface INotificacionNormaSuscritaUseCase {
		...
		public Task<List<(string Cron, TipoUnidadTiempo? UnidadTiempoAntelacion, int? CantAntelacion, bool EsVencimiento)>> GenerarCrons(DateTime proximoVencimientoUtc, string baseCronAws, List<(TipoUnidadTiempo TipoUnidadTiempo, int CantAntelacion)> antelaciones, TipoPeriodicidad tipoPeriodicidad);
