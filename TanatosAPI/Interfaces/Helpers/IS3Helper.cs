namespace TanatosAPI.Interfaces.Helpers {
    public interface IS3Helper {
        ...
        public Task<string> ObtenerGetPreSignedUrl(string bucketName, string bucketKey, string nombreArchivo, bool inline = false);
        public Task<(string url, Dictionary<string, string> fields)> ObtenerPostPreSignedUrl(string bucketName, string bucketKey, string contentType, long size);
