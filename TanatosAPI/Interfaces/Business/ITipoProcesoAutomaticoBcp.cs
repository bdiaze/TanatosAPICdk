...
namespace TanatosAPI.Interfaces.Business {
	public interface ITipoProcesoAutomaticoBcp {
		...
		public Task<TipoProcesoAutomatico?> Obtener(long id, bool filtrarHabilitado = false, bool validarHabilitado = false, NpgsqlTransaction? transaction = null);
		public Task<List<TipoProcesoAutomatico>> ObtenerTodos(bool filtrarHabilitados = false, NpgsqlTransaction? transaction = null);
