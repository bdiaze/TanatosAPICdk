...
namespace TanatosAPI.Interfaces.Business {
	public interface INotificacionNormaSuscritaBcp {
		...
		public Task<List<NotificacionNormaSuscrita>> ActualizarPorNormaSuscrita(long idNormaSuscrita, HashSet<(long IdTipoUnidadTiempoAntelacion, int CantAntelacion)> notificacionesNormaSuscrita, NpgsqlTransaction? transaction = null);
	}
}
