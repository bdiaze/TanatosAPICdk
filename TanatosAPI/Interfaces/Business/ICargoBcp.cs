...
namespace TanatosAPI.Interfaces.Business {
	public interface ICargoBcp {
		...
		public Task<Cargo?> ObtenerSoloVigente(long idCargo, NpgsqlTransaction? transaction = null);
		...
		public Task<List<Cargo>> ObtenerVigentes(string sub, long? idNegocio, NpgsqlTransaction? transaction = null);
