...
namespace TanatosAPI.Endpoints {
	public static class NormaSuscritaEndpoints {
		...
		private static IEndpointRouteBuilder MapCrearEndpoint(this IEndpointRouteBuilder routes) {
			routes.MapPost("/", async (EntNormaSuscritaCrear entrada, IHostEnvironment environment, ClaimsPrincipal user, NormaSuscritaDao normaSuscritaDao, TipoPeriodicidadDao tipoPeriodicidadDao, CategoriaNormaDao categoriaNormaDao, NegocioDao negocioDao) => {
				Stopwatch stopwatch = Stopwatch.StartNew();
				...
				try {
					...
					nuevo.Id = await normaSuscritaDao.Insertar(nuevo);
		...
		private static IEndpointRouteBuilder MapActualizarEndpoint(this IEndpointRouteBuilder routes) {
			routes.MapPut("/", async (EntNormaSuscritaActualizar entrada, IHostEnvironment environment, ClaimsPrincipal user, NormaSuscritaDao normaSuscritaDao, TipoPeriodicidadDao tipoPeriodicidadDao, CategoriaNormaDao categoriaNormaDao, NegocioDao negocioDao) => {
				Stopwatch stopwatch = Stopwatch.StartNew();
