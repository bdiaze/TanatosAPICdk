...
namespace TanatosAPI.UseCases {
	public class TipoProcesoAutomaticoUseCase(ITipoProcesoAutomaticoBcp tipoProcesoAutomaticoBcp) {
		...
		public async Task<TipoProcesoAutomatico> Registrar(string nombre, string? descripcion, bool habilitado, int orden) {
			nombre = nombre.Trim();
			...
			return await tipoProcesoAutomaticoBcp.Insertar(nombre, descripcion, habilitado, orden);
		}
		...
		public async Task<TipoProcesoAutomatico> Actualizar(long id, string nombre, string? descripcion, bool habilitado, int orden) {
			...
			TipoProcesoAutomatico existente = (await tipoProcesoAutomaticoBcp.Obtener(id, validarVigencia: true))!;
